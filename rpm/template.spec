...
Name:           ros-humble-autoware-topic-text-overlay-rviz-plugin
Version:        0.5.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS autoware_topic_text_overlay_rviz_plugin package

License:        Apache License 2.0
URL:            https://index.ros.org/p/autoware_topic_text_overlay_rviz_plugin/#humble
...
%description
RViz panel plugin for overlaying selected text topics in the 3D view.
...
%changelog
* Tue May 05 2026 Satoshi Ota <satoshi.ota@tier4.jp> - 0.5.0-1
